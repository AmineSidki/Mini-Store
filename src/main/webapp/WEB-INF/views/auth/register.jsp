...
<div class="text-center w-full max-w-lg">
    ...
    <div class="w-full bg-white p-8 shadow-2xl rounded-2xl animate-fade-in-up">
        ...
        <form id="register_form" action="register" method="post" class="space-y-3">
        ...
        <p class="mt-6 font-sans text-gray-600">
            ...
            <a href="login" class="font-medium text-blue-500 hover:text-blue-600 transition-colors duration-150">
                Sign in
            </a>
        </p>
